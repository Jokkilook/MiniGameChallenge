...
PUNG.defineLevel('peak', {
  ...
  collapse: {
    ...
    first: 26,                       // 첫 붕괴까지(초)
    /* 고리가 두 겹 더 늘어(지름 36m → 50.4m) 떨어질 것이 다섯에서 일곱이 됐다.
       8.5 를 그대로 두면 한 판이 60초에서 77초로 늘어난다 — 6.0 이면 26 + 6*6.0
       = 62초로 예전 길이와 거의 같다. */
    every: 6.0,                      // 고리 한 겹이 무너지는 간격(초)
    /* 예고는 '피할 시간'이라 간격과 같이 늘려야 한다 — 간격만 늘리고 이걸 두면
       무너지는 순간의 급작스러움은 그대로다. */
...
PUNG.defineLevel('tutorial', {
  ...
  boxes: [
    ...
    /* ── 부스 3 · 깃털 (20.8, -12) · 뒤판 +X ──
       ...
       위 11m 는 활공이 1초·낙하 1.4m/s 이던 시절의 값이다. 지금 활공은 그때보다
       전부 세다(2.8초 · 낙하 1.1m/s · 발동 추진 · 공중 조작 개방) — 즉 여유가 늘었을
       뿐이라 8m 는 그대로 건너간다. 다시 재지는 않았으므로 위 숫자는 '최소한 이만큼'
       으로 읽으면 된다. 이 부스에서 확인시킬 것도 바뀌었다: 예전에는 '떠서 건너간다'
       하나였는데, 이제 방향 전환이 되므로 '틀어서 내려앉는다' 까지가 배울 내용이다.
  ...
  /* 허수아비는 '남에게 일어나는 일' 을 가르치는 부스에만 둔다.
     과충전·펄스가 그렇다 — 맞는 쪽이 어떻게 되는지가 배울 내용이다.

     깃털·닻·리버스캡슐은 뺐다. 셋 다 내 몸에 일어나는 일이라 상대가 필요 없다. 세워 두면
     "쟤한테 뭘 해야 하나" 로 읽혀 오히려 헷갈린다 — 그 자리에는 대신 몸으로 확인할
     구조물을 뒀다(위 boxes 의 착지판과 기준 단, 그리고 리버스캡슐 부스의 뒤판).
     리버스캡슐은 예전에 '상대를 끌어당기는' 물건이라 여기 있었는데, 이제 끌려오는 것은
     상대가 아니라 나다(index.html 의 applyGrapple) — 허수아비를 세워 두면 배울 내용과
     정반대의 것을 시키게 된다.
  ...
  zones: [
    ...
    {x:20.8, z:12, r:11, y:0.5, item:'drum',
     text:'탄창이 즉시 가득 차고, 재장전 속도가 2.2배 빨라집니다.',
    ...
    {x:20.8, z:-12, r:18, y:0.5, item:'feather',
     text:'발밑을 쏘면 훨씬 멀리 날아갑니다. <b>F</b> 로 활공하면 천천히 내려오면서 <b>공중에서도 마음대로 방향을 틀 수</b> 있습니다 — 밀려 떨어졌을 때 판으로 돌아오는 수단입니다.',
     how:'도약대에서 문 밖으로 뛴 다음, 공중에서 <b>F</b> 를 누르세요! 활공하는 동안 방향을 틀어 건너편 착지판에 내려앉아 보세요.',
     signSub:'F · 활공 복귀'},

    {x:0, z:-24, r:11, y:0.5, item:'reverse',
     text:'내 폭발이 나를 <b>폭발 지점으로 끌어당깁니다</b>. 상대를 미는 힘은 그대로고, 대신 지형을 쏘아 그쪽으로 날아갈 수 있습니다.',
     how:'앞쪽 <b>벽 위쪽</b>을 쏴 보세요! 그쪽으로 끌려갑니다. 밀려 떨어졌을 때 판 가장자리를 쏘면 다시 올라올 수 있습니다.',
     signSub:'끌어당겨 이동'},
    ...
    {x:-20.8, z:12, r:11, y:0.5, item:'pulse',
     text:'<b>F</b> 를 누르면 내 주위 <b>10.5m</b> 로 충격파가 퍼집니다. 가장자리까지 힘이 살아 있어서, 붙지 않아도 여러 명을 한 번에 밀어냅니다.',
     how:'집으면 발밑에 <b>사거리 고리</b>가 계속 떠 있습니다. 허수아비가 그 안에 들어오게 선 다음 <b>F</b> 를 누르세요!',
     signSub:'F · 광역 충격파'}
  ],
